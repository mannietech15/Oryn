  ...
  useEffect(() => {
    ...
    if (autoAnimate) {
      autoInterval = setInterval(() => {
        ...
        updatePointerDownData(pointer, -1, randomX, randomY);
        clickSplat(pointer);
        
        // Follow up with a small swish
        setTimeout(() => {
          updatePointerMoveData(pointer, randomX + (Math.random() - 0.5) * 100, randomY + (Math.random() - 0.5) * 100, pointer.color);
        }, 50);
      }, 800); // Splat every 800ms
    }
